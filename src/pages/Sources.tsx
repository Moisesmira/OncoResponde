...
const sources = [
  ...
  { name: 'Sociedad Española de Oncología Radioterápica (SEOR)', url: 'https://seor.es/guias-de-pacientes/', detail: 'Guías para pacientes sobre radioterapia, preparación, efectos secundarios, cuidados y preguntas frecuentes.' },
...
export default function Sources() {
  return <main className="sources-page">
    ...
    <section className="card source-check"><h2>Antes de confiar en una página</h2><ul><li>Comprueba quién publica la información y cuándo se actualizó.</li><li>Desconfía de curas garantizadas, testimonios como única prueba o productos que prometen sustituir el tratamiento.</li><li>Comenta con tu equipo sanitario cualquier información que pueda influir en tus decisiones.</li></ul><p><strong>Las respuestas de OncoResponde se elaboran utilizando información procedente de fuentes científicas y guías clínicas de referencia. Siempre que sea posible, la IA indicará la fuente utilizada. La información ofrecida es orientativa y no sustituye la valoración de tu equipo sanitario.</strong></p></section>
  </main>;
}
